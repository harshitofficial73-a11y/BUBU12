...
(function () {
  ...
  async function bootstrap() {
    ...
    return { signedIn: true, account, categories, districts, products, ownProducts, orders: [], conversations, leads, dashboard, leadCredit, buyerQuoteManager, adminMembers, adminAnalytics, tenders, supplierHistory, productInterests, interestNotifications, buyerNotifications };
  }
