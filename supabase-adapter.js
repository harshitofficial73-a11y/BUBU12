...
(function () {
  ...
  async function searchProducts({ query = '', category = null, mine = false, id = null, limit = 100 } = {}) {
    let q = sb.from('products').select(`*,categories(name,parent_id),accounts!products_supplier_id_fkey(company,district_id,business_type,tier),
  ...
  window.BUBU_API = { client: sb, auth, bootstrap, loadAccount, loadCategories, searchProducts, productById, saveProduct,
