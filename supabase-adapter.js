...
(function () {
  ...
  async function bootstrap() {
    ...
    const [products, ownProducts, conversations, leads, dashboard, leadCredit, buyerQuoteManager, adminMembers, adminAnalytics, tenders, supplierHistory, productInterests, interestNotifications, buyerNotifications] = await Promise.all([
    ...
    return { signedIn: true, account, categories, products, ownProducts, orders: [], conversations, leads, dashboard, leadCredit, buyerQuoteManager, adminMembers, adminAnalytics, tenders, supplierHistory, productInterests, interestNotifications, buyerNotifications };
  }
